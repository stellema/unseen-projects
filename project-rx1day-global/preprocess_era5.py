"""Command line program for ERA5 data pre-processing (copied from project-bias)."""
...
def main(args):
    """Run the program."""
    project = 'rx1day-global'
    cmor_var = var_to_cmor_name[args.var]

    outdir = f'/g/data/xv83/unseen-projects/outputs/{project}/data/era5'
